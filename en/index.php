...
else
{
	...
	if($row[id]){$idpais = $row[id];}
	if($row[paisEN]){$pais = "<a href=./country/?id=".$row[id].">".$row[paisEN]."</a><br>";}
  ...
  <div id="header">
    ...
    <div id="navigation">
       <ul>
         ...
         <?php if(1==2) { ?><li><a title="Social pensions database" href="../../bdps/en"><?php echo $nav_ps; ?></a></li>
		 <li><a title="Labour and productive inclusion programmes database" href="../../bdilp/en">ILP</a></li><?php } else { } ?>
       </ul>
          <!-- 
