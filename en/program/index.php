...
// General config campos segun idioma
	...
	{ 
		...
		$lblreg = "Registro de beneficiarios";
	...
	// Datos
	if($row[archivo_electronico]){$archivo="<a href=\"http://$URL_SITIO$PATH_ARCHIVOS_WEB_RECURSOS/$id/$row[archivo_electronico]\"><img src=\"../../images/$imgexcel\" title=\"Expenditure data, coverage and amount of money transfers\" border=\"0\" align=\"absbottom\" /></a>";}
...
<div id="container" class="doublecol">
  ...
  <div id="header">
    ...
    <ul class="basictab">
                  ...
                  <li><a href="./references.php?id=<?php echo $id; ?>"><?php echo $tabref; ?> (<?php echo $total_ref; ?>) </a></li>
              </ul> 
             </td>
