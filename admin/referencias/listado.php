...
if($_SESSION['usuario_nivel'] == 1)
{
	if($todos)
	{
	$query  = "SELECT rp.* FROM referencias rp, programas p WHERE rp.id_programa=p.id AND p.id=$id_programa ORDER BY rp.id";
	}else
	{
	$query  = "SELECT rp.* FROM referencias rp, programas p WHERE rp.id_programa=p.id AND p.id=$id_programa ORDER BY rp.id LIMIT 0,300";
	}
}
...
END;
		...
		<tr>
			...
			<td><div align="center"><a href="#" onClick="if(confirm('Desea borrar el registro $row[titulo]')){document.location.href='borra.php?id=$row[id]&id_programa=$id_programa'}"><img src="../img/delete.png" alt="Borrar" border="0"></a></div></td>
...
// Menu relaciones programa
	$rel_prog = "<ul class=\"basictab\"><li><a href=\"../programas/ficha.php?id=$id_programa\">General</a></li><li><a href=\"../componentes/listado.php?id_programa=$id_programa\">Componentes</a></li><li class=\"selected\"><a href=\"../referencias/listado.php?id_programa=$id_programa\">Referencias</a></li></ul>"; 
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<p class="linkboton" align="center">Nueva referencia</p>
	</a></div></td>
  </tr>
  <tr>
